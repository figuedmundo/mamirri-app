...
export function Cronograma({
  ...
  const sortedSessions = [...sesiones].sort(
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div
                        className={`flex-shrink-0 flex flex-col items-center justify-center w-10 h-10 rounded-lg ${getPainColor(sesion.dolorFinal)}`}
                      >
