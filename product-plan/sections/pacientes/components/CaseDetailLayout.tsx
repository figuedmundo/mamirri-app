...
export function CaseDetailLayout({
  ...
  const activeSession = caso.sesionesTratamiento.find(
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {activeSession ? (
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                      {new Date(activeSession.fecha).toLocaleDateString(
                        undefined,
                        {
                          weekday: 'long',
                          year: 'numeric',
                  ...
                  <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-lg">
                    ...
                    <span
                      className={`text-lg font-bold ${activeSession.dolorFinal > 5 ? 'text-rose-500' : 'text-emerald-500'}`}
                    >
                ...
                {activeSession.notasVoz &&
                  activeSession.notasVoz.length > 0 && (
