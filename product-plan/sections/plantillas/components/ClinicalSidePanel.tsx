          ...
          <div className="space-y-2">
            {caso.evaluacion.hallazgos.map((hallazgo, idx) => (
              <div key={idx} className="flex gap-3 items-start group">
                <AlertCircle
                  size={14}
                  className="mt-1 text-sky-500 shrink-0 group-hover:scale-110 transition-transform"
                />
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
            <div className="grid grid-cols-2 gap-2">
              <div className="aspect-[3/4] bg-slate-100 dark:bg-slate-800 rounded-lg relative overflow-hidden border border-slate-200 dark:border-slate-700">
                <div className="absolute inset-0 flex items-center justify-center text-[10px] text-slate-400 uppercase tracking-widest font-medium">
                  Posturograma
                </div>
              </div>
              <div className="aspect-[3/4] bg-slate-100 dark:bg-slate-800 rounded-lg relative overflow-hidden border border-slate-200 dark:border-slate-700">
