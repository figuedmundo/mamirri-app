          ...
          <div className="space-y-5">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono text-teal-600 dark:text-teal-400">
                  {plantilla.parametros.alturaArco}mm
                </span>
              </div>
              <input
                type="range"
                ...
                onChange={(e) =>
                  onUpdateParameter('alturaArco', Number(e.target.value))
                }
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono text-teal-600 dark:text-teal-400">
                  {plantilla.parametros.cuñaTalon}°
                </span>
              </div>
              <input
                type="range"
                ...
                onChange={(e) =>
                  onUpdateParameter('cuñaTalon', Number(e.target.value))
                }
                className="w-full h-1 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-teal-500"
              />
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              >
                <span
                  className={`w-4 h-4 bg-white rounded-full shadow transform transition-transform duration-200 ${plantilla.parametros.barrametatarsal ? 'translate-x-6' : 'translate-x-1'}`}
                />
              </button>
            </div>
          </div>
