          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400">
                Consulta evidencia global y protocolos especializados
              </p>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700">
              ...
              <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
                {diagramas.map((diag) => (
                  <div
                    key={diag.id}
                    className="min-w-[200px] aspect-[4/3] bg-slate-100 dark:bg-slate-900 rounded-lg flex items-center justify-center border border-slate-200 dark:border-slate-700 relative overflow-hidden group cursor-pointer"
                  >
                    <span className="text-xs text-slate-400 font-mono z-10">
                      {diag.titulo}
                    </span>
