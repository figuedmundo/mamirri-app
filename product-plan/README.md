# Mamirri App — Design Handoff

This folder contains everything needed to implement Mamirri App.
...
5. Answer the agent's clarifying questions about auth and data modeling
...
The test instructions are **framework-agnostic** — they describe WHAT to test, not HOW. Adapt to your testing setup (Jest, Vitest, Playwright, Cypress, React Testing Library, RSpec, Minitest, PHPUnit, etc.).
