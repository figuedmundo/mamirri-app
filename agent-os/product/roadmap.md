...
1.1 [x] **Repositorio:** Crear Repo Monorepo (Git) con estructura `/client` y `/server`.
• [x] **Base de Datos:**
...
◦ _Hito:_ Poder abrir la URL en el iPad de tu madre y ver una pantalla en blanco que diga "PhysioCopilot v0.1".
...
◦ _Prueba:_ Dictar un párrafo médico rápido y verificar precisión.
...
◦ _¿Dónde se traba?_
◦ _¿Qué botones no ve?_
◦ _¿La transcripción entiende sus términos médicos?_
