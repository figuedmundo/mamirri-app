...
- [ ] 1.0 Complete Clinic model and migrations
  - [ ] 1.1 Write 4-6 focused tests for Clinic model
  ...
  - [ ] 1.4 Add `clinicId` foreign key to User model
...
- [ ] 2.0 Add clinicId to all tenant-scoped tables
  - [ ] 2.1 Add `clinicId` to ClinicalCase model
    - ClinicalCase inherits clinic from Patient (via patient.clinicId)
    - Add relation or computed field
    - Create migration
  - [ ] 2.2 Add `clinicId` to TreatmentSession model
    - Inherits from ClinicalCase
    - Create migration with index
  - [ ] 2.3 Add `clinicId` to Evaluation model
    - Inherits from ClinicalCase
    - Create migration with index
  - [ ] 2.4 Add `clinicId` to Session model
    - Inherits from Patient
    - Create migration with index
  - [ ] 2.5 Add `clinicId` to SessionPhoto model
    - Inherits from TreatmentSession
    - Create migration with index
  - [ ] 2.6 Add `clinicId` to AiAnalysis model
    - Inherits from ClinicalCase
    - Create migration with index
  - [ ] 2.7 Add `clinicId` to AiFeedback model
    - Inherits from AiAnalysis
    - Create migration with index
  - [ ] 2.8 Run all database migrations and verify schema
...
- [ ] 3.0 Implement Row-Level Security policies
  - [ ] 3.1 Write 4-6 tests for RLS policies
  ...
  - [ ] 3.2 Enable RLS on tenant-scoped tables
  ...
  - [ ] 3.3 Create RLS policies for direct clinic association
  ...
  - [ ] 3.4 Create RLS policies for indirect clinic association
...
- [ ] 4.0 Update authentication to include clinic context
  ...
  - [ ] 4.4 Update CurrentUser decorator
...
- [ ] 5.0 Implement Roles decorator and ClinicRolesGuard
  - [ ] 5.1 Write 5-6 tests for role-based access control
...
- [ ] 6.0 Create Clinic module and admin endpoints
  - [ ] 6.1 Write 5-6 tests for clinic API endpoints
  ...
  - [ ] 6.2 Create Clinic module structure
  ...
  - [ ] 6.3 Implement POST /admin/clinics (ADMIN only)
    - Create clinic with provided details
    - Return clinic data
  - [ ] 6.4 Implement GET /admin/clinics (ADMIN only)
    - List all clinics with pagination
    - Include therapist count, patient count
  - [ ] 6.5 Implement GET /clinics/:id (CLINIC_OWNER+)
    - Get clinic by ID
    - Verify user belongs to clinic
    - Include related data (counts)
  - [ ] 6.6 Implement PATCH /clinics/:id (CLINIC_OWNER+)
    - Update clinic settings
    - Validate ownership
  - [ ] 6.7 Ensure clinic API tests pass
...
- [ ] 7.0 Implement invitation workflow
  - [ ] 7.1 Write 6-7 tests for invitation system
  ...
  - [ ] 7.5 Create invitation email template
...
- [ ] 8.0 Update all services to filter by clinicId
  - [ ] 8.1 Update PatientsService
...
- [ ] 9.0 Update frontend authentication
  - [ ] 9.1 Update AuthContext
  ...
  - [ ] 9.3 Add clinic display to header
    - Show clinic name in navbar
    - Show user role badge
  - [ ] 9.4 Create useClinic hook
    - Returns current clinic context
    - Helper for checking permissions
  - [ ] 9.5 Write 2-3 tests for auth context
...
- [ ] 10.0 Create clinic management UI
  ...
  - [ ] 10.6 Write 3-4 tests for clinic UI
  ...
  - [ ] 10.7 Ensure clinic UI tests pass
...
- [ ] 11.0 Comprehensive tenant isolation tests
  - [ ] 11.1 Write integration tests for cross-tenant access
...
- [ ] 12.0 Final integration testing and cleanup
  - [ ] 12.1 Verify all existing endpoints still work
    - Run existing test suites
    - Fix any regressions
  - [ ] 12.2 Verify RLS policies are active
