...
- [x] 1.0 Complete CaseDetailLayout callback integration
...
- [x] 2.0 Complete PatientProfile callback integration
...
- [x] 3.0 Complete EvaluationForm callback wiring
...
- [x] 4.0 Complete PosturogramViewer callback wiring
